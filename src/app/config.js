...
exports.creds = {
    ...
    // feature.
    identityMetadata: 'https://login.microsoftonline.com/bluebankb2c.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
    // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'
  
    // Required, the client ID of your app in AAD  
    clientID: 'f236fe43-41fd-4687-bcf2-5de2da784eda',
    ...
    resourceURL: 'https://login.microsoftonline.com/bluebankb2c.onmicrosoft.com/oauth2/v2.0/token?p=B2C_1_BlueBankSUSI',
  ...
  exports.destroySessionUrl = 
    'https://login.microsoftonline.com/bluebankb2c.onmicrosoft.com/oauth2/v2.0/logout' +
